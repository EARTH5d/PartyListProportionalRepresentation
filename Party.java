...
/**
 * Class Party - A class that represents a political party competing in an election using party list PR. 
 * Through in an honestly I am more of a Single Tranferable Voting or Proportional Approval Voting kind of guy. I just do not want to create all the ballots.
 * Plus I also wasn't aware that Proportional forms of approval voting existence when I first start to make this.
 *
